        ...
        <footer className="border-t border-dark-border bg-dark-card">
            <div className="section-shell max-w-[min(96vw,110rem)] py-12">
                <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8">
                    ...
                    {/* Links */}
                    <div>
                        <h4 className="font-semibold text-white text-sm mb-4">Links rápidos</h4>
                        <ul className="space-y-2">
                            {[
                                { label: "O Projeto", href: "#about" },
                                { label: "Planos", href: "#plans" },
                                { label: "FAQ", href: "#faq" },
                                { label: "Pré-cadastro", href: "#contact" },
                            ].map((link) => (
                                <li key={link.href}>
                                    <a
                                        href={link.href}
                    ...
                    {/* Contact */}
                    <div>
                        <h4 className="font-semibold text-white text-sm mb-4">Contato</h4>
                        <a
                            href="https://wa.me/5531999999999"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-2 text-text-muted text-sm hover:text-green-500 transition-colors"
                        >
                ...
                <div className="border-t border-dark-border mt-8 pt-8 text-center">
                    <p className="text-text-muted text-xs">
                        © {currentYear} Innova Mídia Led. Todos os direitos reservados.
                    </p>
                </div>
            </div>
        </footer>
