...
const specs = [
    ...
    },
    {
        ...
        title: "P5 — Alta Definição",
        detail: "Resolução máxima de imagem",
    },
    {
        icon: (
            <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        title: "Vídeos & Motion",
        detail: "Artes estáticas e animadas",
    },
    {
        icon: (
            <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        title: "Dia & Noite",
        detail: "Boa leitura em qualquer condição",
    },
];
